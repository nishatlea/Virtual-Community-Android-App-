...
public class Answer {
    ...
    private String ans_from;

    public String getAns_from() {
        return ans_from;
    }

    public void setAns_from(String ans_from) {
        this.ans_from = ans_from;
    }
    ...
    public Answer(String userId, String key,String ans_from, String answerString, long timeStamp,
                  int numberUpVotes) {
        setUserId(userId);
        setAnswerId(key);
