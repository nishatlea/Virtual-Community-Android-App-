...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        /*if(mAuth.getCurrentUser().getUid()!= null && name != null) {
            ref.child(mAuth.getCurrentUser().getUid()).child("name").setValue(name);
            ref.child(mAuth.getCurrentUser().getUid()).child("latitude").setValue(latmark);
            ref.child(mAuth.getCurrentUser().getUid()).child("longitude").setValue(longmark);
        }*/
        ...
        ref.child(parseUser1.getObjectId()).child("longitude").setValue(longmark);
        ref.child(parseUser1.getObjectId()).child("line").setValue("Online");
  ...
  flag=0;
                        ...
                        if (postSnapshot.child("line") !=null && postSnapshot.child("latitude") != null && postSnapshot.child("longitude") != null && postSnapshot.child("name") != null) {

                            if (postSnapshot.child("line").exists()) {
                                String check = (String) postSnapshot.child("line").getValue();
